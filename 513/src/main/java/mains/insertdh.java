    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (x.contains("data:image/png;base64")) {
                ...
                System.out.println(req.getServletContext().getRealPath("picture"));
                imgutil.GenerateImage(x,req.getServletContext().getRealPath("picture")+"/"+tar);
                st.setText("../picture/"+tar);
            } else {
